        ...
        <div className="max-w-md mx-auto bg-deep  rounded-lg shadow-lg overflow-hidden">
          <div className="p-6">
            <div className="flex flex-col gap-4">
              <Button
                href="mailto:anthonyygpz@gmail.com"
                className="group btn-brown-outline flex items-center gap-3 p-3 border-brown text-white hover:text-black rounded-md transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              <Button
                href="https://github.com/anthonnyygpz"
                target="_blank"
                className="group btn-brown-outline flex items-center gap-3 p-3 border-brown text-white hover:text-black rounded-md transition-colors"
              >
                <svg
              ...
              >
                ...
                <span>linkedin.com/in/antonio-gallegos-palafox</span>
              </Button>
            </div>
